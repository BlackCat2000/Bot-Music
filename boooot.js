...
client.on('ready', function() {
    ...
    client.user.setGame(prefix + 'TRAP-BOT');
});
...
//	console.log('yao: ' + Util.escapeMarkdown(video.thumbnailUrl));
	...
	if (!serverQueue) {
		...
		try {
			...
			console.error(` join the voice channel: ${error}`);
...
if (message.content.startsWith(PREFIX + 'setavatar')) {
  client.user.setAvatar(argresult, "https://discordapp.com/api/oauth2/authorize?client_id=559004836809670656&permissions=8&scope=bot");
